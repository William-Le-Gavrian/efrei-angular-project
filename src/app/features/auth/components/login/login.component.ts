...
@Component({
  ...
  template: `
    <div class="container">
      <div class="min-vh-100 w-auto d-flex flex-column align-items-center justify-content-center">
          ...
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
            <div class="mb-5">
              <div class="mb-3 ">
                ...
                <input type="email" id="email" class="form-control fs-5" formControlName="email" />
